...
contract StakingFactoryTest is Test {
    ...
    function testCreateStakingContract() public {
        ...
        address stakingAddress = factory.createStakingContract(address(token));
    ...
    function testGetAllStakingStats() public {
        ...
        address stakingAddress1 = factory.createStakingContract(address(token));
        address stakingAddress2 = factory.createStakingContract(address(token));
